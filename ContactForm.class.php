...
class ContactForm extends Form {
  ...
  public function submit() {
    ...
    parent::submit();
    //System::setMessage('Submitting the form.');
    $mail = new PhpMail();
    $mail->from($this->data['mail'], $this->data['from']);
    $mail->addRecipient('chris.albrecht@nrel.gov', 'Shaun');
    $mail->addCC('shaun.laws@nrel.gov');
    $mail->subject($this->data['subject']);
    $mail->replyTo('mayhem@162unlimited.com', 'Mayhem');
